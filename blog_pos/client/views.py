...
def manager_required(view_func):
    """Décorateur pour vérifier que l'utilisateur est manager, staff ou superuser"""
    @wraps(view_func)
    def _wrapped_view(request, *args, **kwargs):
        ...
        # Vérifier si l'utilisateur est manager, staff ou superuser
        if not (request.user.is_manager() or request.user.is_staff or request.user.is_superuser):
